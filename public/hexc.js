...
*/
var aa=__webpack_require__(0),n=__webpack_require__(1),r=__webpack_require__(9);function ba(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[c,d,e,f,g,h],k=0;a=Error(b.replace(/%s/g,function(){return l[k++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var compute = __webpack_require__(12);

var colorsByCode = __webpack_require__(3);
...
function (_React$Component) {
  ...
  function Main(props) {
    ...
    if (props.hexadecimal) {
      _this.state = compute(props.hexadecimal, 'hexadecimal');
    } else {
      _this.state = {
        base256: null,
        binary: null,
    ...
    _this.showNewWindow = location.href.indexOf('#') === -1 && 'undefined' !== typeof browser;
    return _this;
  }
...
const converter = __webpack_require__(13);
const validate = __webpack_require__(14);
const colorsByCode = __webpack_require__(3);
